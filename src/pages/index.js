      ...
      <div>
        ...
        >
          <div className="md:ml-8 md:mt-3 lg:ml-12">
            <div className="text-3xl font-medium md:text-3xl md:font-bold text-gray-100 lgx:text-4xl">
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            A weekly podcast about movies. Sometimes new movies, often old
            movies, frequently bad movies. We like long strolls on the beach,
            relaxing afternoons at the cinema, monkey mudwrestling, and
            listeners like you.
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl" />
                  ...
                  >
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: formatSubTitle(node.itunes.subtitle)
                      }}
                    >
